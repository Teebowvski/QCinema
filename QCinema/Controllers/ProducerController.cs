...
namespace QCinema.Controllers
{
    public class ProducerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ImageUrl,Bio")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,ImageUrl,Bio")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
